...
totalCharge_ref_EPSC = -0.09; %ref charge for EPSCs - previously -0.09
...
save('\\apollo\research\ENT\Takesian Lab\Ephys Data Analysis\0_settings\optoSetup_default.mat');